...
export const BottomDualBanners: React.FC<BottomDualBannersProps> = ({
  ...
  return (
    <section
      ...
      className="max-w-7xl mx-auto mt-2 sm:mt-3 mb-0 pb-0 px-2 sm:px-4 md:px-0 relative"
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3.5">
        ...
        <div
          className={`w-full relative rounded-2xl sm:rounded-3xl overflow-hidden bg-[#121214] shadow-md group ${
        ...
        >
          <a
            ...
            className="block relative w-full h-28 sm:h-36 md:h-44 overflow-hidden cursor-pointer"
          >
            <img
              src={banner1Img}
              alt="Promoción 1"
